    ...
    Alertify = function () {
        ...
        _alertify = {
            ...
            notify: function (message, type, wait, clickToClose) {
                ...
                log.className = "alertify-log" + ((typeof type === "string" && type !== "") ? " alertify-log-" + type : " alertify-log-" + uniqueId);
        ...
        return {
            ...
            log: function (message, type, wait, clickToClose) {
                _alertify.log(message, type, wait, clickToClose);
                return uniqueId;
            },

            success: function (message, wait, clickToClose) {
                _alertify.log(message, "success", wait, clickToClose);
                return uniqueId;
            },

            error: function (message, wait, clickToClose) {
                _alertify.log(message, "error", wait, clickToClose);
                return uniqueId;
            },
            ...
            closeNow: function (uniqueId) {
                _alertify.closeNow(uniqueId);
            },

            closeAll: function () {
                _alertify.closeNow("show");
            }
        };
    };
